...
/**
 * React Bits — DecryptedText (JS-TW), adapted.
 * Source: https://reactbits.dev  ·  added via `shadcn add @react-bits/DecryptedText-JS-TW`
 *
 * Local change: a reduced-motion branch that renders the plain string.
 */
...
export default function DecryptedText({
  ...
  /* Reduced motion: no scramble, no listeners — just the text.
     Added locally; the registry version always animates. */
